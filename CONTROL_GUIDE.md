...
**استخراج الصور من المقالات الأصلية**:
النظام يقوم تلقائياً بـ:
1. **استخراج الصور من المقالات الأصلية** في RSS feeds
2. **استخدام الصور الأصلية** مع إضافة نص حقوق الطبع والنشر
3. **الاحتياط إلى Unsplash** في حالة عدم وجود صور في المقال الأصلي
...
**حقوق الصور**:
جميع الصور تتضمن تلقائياً نص: "حقوق الصورة محفوظة للمصدر الأصلي"
...
**استخدام المحتوى الجزئي**:
النظام يقوم تلقائياً بـ:
1. **استخدام نصف المحتوى فقط** من المقال الأصلي لاحترام حقوق الطبع والنشر
2. **إضافة رابط "إكمال القراءة"** للمصدر الأصلي
3. **إضافة نص حقوق المحتوى** محفوظة للمصدر الأصلي
